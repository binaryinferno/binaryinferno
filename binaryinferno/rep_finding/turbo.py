...
# Used to debugging the timeing of the Iterative Deepening Depth First Search

# cat nums.txt | parallel --halt now,success=1 "python3 ./turbo.py {}"

import sys
import time
v = sys.argv[1]
if int(v) == 5:
	print("got 5 coming shallow")
	time.sleep(1)
	sys.exit(0)
else:
	print("got",v,"going deep")
	time.sleep(2)
	sys.exit(1)
